...
enum nubot_substate
{
  ...
  class NubotGazebo : public gazebo::ModelPlugin
  {
    private:
        ...
        gazebo::physics::ModelPtr           nubot_model_;       // Pointer to the model
        gazebo::physics::ModelPtr           football_model_;    // Pointer to the football
        gazebo::physics::LinkPtr            football_link_;     //Pointer to the football link
        gazebo::physics::LinkPtr            nubot_link_;
        ...
        gazebo::common::Time                  receive_sim_time_;
        gazebo::common::Time                  last_current_time_;

        ignition::math::Vector3d               desired_rot_vector_;
        ignition::math::Vector3d               desired_trans_vector_;
        ignition::math::Vector3d               nubot_football_vector_;
        ...
        void nubot_locomotion(ignition::math::Vector3d linear_vel_vector, ignition::math::Vector3d angular_vel_vector);  // rotation + translation
        ...
        bool get_rot_vector(ignition::math::Vector3d target_point_world, double degree_thres);
        ...
        bool get_trans_vector(ignition::math::Vector3d target_point_world, double metre_thres);
        ...
        void ball_vel_decay(ignition::math::Vector3d vel, double mu);
        ...
        void set_ball_vel(ignition::math::Vector3d &vel, bool &ball_decay_flag);
